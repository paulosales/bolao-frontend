      ...
      <table className="w-full text-sm">
        <thead className="bg-gray-50 border-b border-gray-200">
          <tr>
            ...
            <th className="py-3 px-4 text-right text-xs font-semibold text-gray-500 uppercase tracking-wide w-24">
              Pontos
            </th>
            <th className="w-10" />
          </tr>
              ...
              <>
                ...
                >
                  ...
                  <td className="py-3 px-4 font-medium text-gray-900">
                    {entry.user_name}
                    {isSelf && (
                      <span className="ml-2 badge badge-blue">Você</span>
                    )}
                  </td>
                          ...
                          <table className="w-full text-xs">
                            <thead>
                              <tr className="text-gray-500">
                                <th className="text-left pb-1">Jogo</th>
                                <th className="text-center pb-1">Aposta</th>
                                <th className="text-center pb-1">Resultado</th>
                            ...
                            <tbody className="divide-y divide-gray-200">
                              {entry.bets.map((bet) => (
                                <tr key={bet.match_id}>
                                  ...
                                  <td className="py-1 text-right font-semibold text-primary-700">
